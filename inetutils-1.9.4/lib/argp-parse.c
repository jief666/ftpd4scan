...
static error_t
group_parse (struct argp_group *group, struct argp_state *state, int key, char *arg)
{
  if (group->parser)
    {
      error_t err;
...
error_t
__argp_parse (const struct argp *argp, int argc, const char * const *argv, unsigned flags,
